...
void delayCallback(const std_msgs::Float32 &msg)
{
	delay = msg.data;
}
...
int main(int argc, char **argv)
{
	...
	std::string delay_subscribe_topic = argv[7];
	...
	ros::Subscriber delay_sub = n.subscribe(delay_subscribe_topic, 10, delayCallback);
