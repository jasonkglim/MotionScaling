...
def visualize_controller(obs_df, prediction_df):
    ...
    # Predicted Heatmaps
    pred_throughput_heatmap = prediction_df.pivot("latency", "scale", "throughput")
    ...
    # Total Error Heatmap
    pred_error_heatmap = prediction_df.pivot("latency", "scale", "total_error")
...
for input_latency in full_latency_list:
    ...
    model.train()
    test_input = player_df[["latency", "scale"]]
